...
<body>	
	<form class="form-horizontal" action="${pageContext.request.contextPath}/course?method=updateCourseServlet" method="post">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" value="${course.credit}"  name="credit" >
			</div>
		</div>
