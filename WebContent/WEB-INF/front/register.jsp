	...
	<body>
		...
		<div class="banner">
			...
			<div class="banner_center">
				<form action="${ctx}/register/addRegister.shtml">
					<div class="register">
						<ul>
							<li class="register_title_1">
								...
								<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;已有账号<a style="color: #F41443;" class="here" href="${ctx}/register/login.shtml">在此登录</a></span>
							</li>
							<li>
								<input name="username" class="register_user" type="text" placeholder="会员名/邮箱/手机号" />
							</li>
							<li>
								<input name="password" class="register_password" type="password" placeholder="密码" />
							</li>
							<li>
								<input class="register_repassword" type="text" placeholder="确认密码" />
							</li>
							<li>
