	...
	<body>
		...
		<div class="banner">
			...
			<div class="banner_center">
				<div class="login">
					<form id="login" action="${pageContext.request.contextPath}/login/loginIndex.shtml" method="post">
						<ul>
							...
							<li>
								<input name="username" class="login_user" type="text" placeholder="用户名" />
							...
							<li class="login_bottom">
								<a href="">忘记密码</a>
								<a href="${ctx}/register/getAddRegister.shtml">免费注册</a>
							</li>
						</ul>
					</form>
				</div>
