	...
	<body>
		...
		<div class="bg_color">
			<div class="top_center">
				<div class="left">
					<span class="wel">
						亲爱的 ${user.username} 欢迎来到靓淘！
					</span>
				</div>
				<div class="right">
					<ul>
						<li><a class="login" href="${ctx}/register/login.shtml" target="_blank">请登录</a></li>
						<li><a href="${ctx}/register/getAddRegister.shtml" target="_blank">快速注册</a></li>
		...
		<div class="logo_center">
			...
			<div class="right">
				<div class="car">
					<a class="car_pic" href="${ctx}/cart/findCart.shtml" target="_blank">去购物车结算</a>
				</div>
		...
		<div class="pc-nav-title">
					...
					<div class="pc-nav-digitclearfix1">
						<ul>
